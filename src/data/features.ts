...
export const FEATURES: Feature[] = [
  ...
  { category: "Study & Learn", roles: ["student"], isNew: true,
    name: "Videos by topic — free",
    desc: "Curated explainer videos, grouped topic-by-topic, playing in a compact in-site mini-player. Free for every student, no purchase needed.",
    how: "Subject → unit → Videos tab. Tap any video card to play it right there." },
  ...
  { category: "For contributors", roles: ["contributor", "admin"], isNew: true,
    ...
    desc: "Add Study-With-AI Q&A, upload materials and drop videos — unit by unit, topic by topic.",
