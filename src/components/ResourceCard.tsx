...
// import { Badge } from "@/components/ui/badge";
// import { Button } from "@/components/ui/button";
// import { ExternalLink, FileText, Video, Link2, Trash2, Eye, Maximize, Minimize, Pencil } from "lucide-react";
// import { supabase } from "@/integrations/supabase/client";
// import { toast } from "sonner";
// import {
//   AlertDialog,
...
//   const canDelete =
//     userRole === "admin" || (userRole === "contributor" && resource.created_by === userId);
...
//   const getRuntimePdfUrl = (url: string) => {
//     const fileId = extractDriveFileId(url);

//     if (fileId) {
//       return `https://yidbijzsfrwqskjzawqq.supabase.co/functions/v1/proxy-pdf?id=${fileId}`;
//     }
...
//         <div
//           className={`w-full rounded-lg border border-border ${
//             isFullscreen ? "h-full overflow-auto touch-auto" : ""
//           }`}
//           style={isFullscreen ? { touchAction: "pan-x pan-y pinch-zoom" } : undefined}
//         >
//           <PdfViewer
//             url={getRuntimePdfUrl(resource.url)}
//             title={resource.title}
